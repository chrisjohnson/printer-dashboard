...
title: Evaluate camera-streaming approach
...
# K-049 — Evaluate camera-streaming approach

## Context

Evaluate camera-streaming approach. Architectural decision about extracting camera code as a reusable package.
