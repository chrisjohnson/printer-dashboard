...
title: Graceful printer disconnect on shutdown
...
# K-014 — Graceful printer disconnect on shutdown

## Context

Graceful printer disconnect on shutdown. Context cancellation for MQTT connections and printer sessions when the server shuts down.
