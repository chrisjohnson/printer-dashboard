...
title: AMS load and unload commands
...
# K-082 — AMS load and unload commands

## Context

AMS load/unload commands. ams_change_filament/unload_filament for Bambu, FEED_AUTO LOAD/UNLOAD for Snapmaker. Needs K-32 (filament status) first.

See `.fleet/research-notes.md`'s K-055 section for the full AMS/filament
protocol reference (load/unload command shapes) before starting.
