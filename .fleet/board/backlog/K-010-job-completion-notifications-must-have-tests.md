...
title: Job completion notifications must have tests
...
# K-010 — Job completion notifications must have tests

## Context

Job completion notifications. Must have tests. Notify user when a print job finishes.
