...
title: Snapmaker 200-with-embedded-error blind spot audit
...
# K-079 — Snapmaker 200-with-embedded-error blind spot audit

## Context

Other Snapmaker Moonraker call sites may share the 200-with-embedded-error blind spot. Audit doCommand, SkipObject, fetchStatus, fetchQueryStatus for the same pattern fixed in K-077.
