...
title: Decouple HMS types from vendor-neutral PrinterStatus struct
...
# K-073 — Decouple HMS types from vendor-neutral PrinterStatus struct

## Context

HMSErrors/HMSWarnings are named after Bambu-specific HMS but bolted onto vendor-neutral PrinterStatus struct. Revisit when Snapmaker gains multi-fault reporting.
