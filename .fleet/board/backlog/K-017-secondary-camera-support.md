...
title: Secondary camera support
...
# K-017 — Secondary camera support

## Context

Secondary camera support. Allow multiple cameras per printer. Deferred — needs camera architecture to settle first.
