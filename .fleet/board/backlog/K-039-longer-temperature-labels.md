...
title: Longer temperature labels
...
# K-039 — Longer temperature labels

## Context

Longer temperature labels. Current temp labels are truncated for some printer configurations. Extend label width. Deferred.
