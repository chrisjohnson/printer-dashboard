...
title: Webhook API for Home Assistant
...
# K-026 — Webhook API for Home Assistant

## Context

Webhook API for Home Assistant integration. Allow external systems to query printer status. Deferred.
