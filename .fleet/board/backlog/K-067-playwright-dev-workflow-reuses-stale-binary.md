...
title: Playwright dev workflow reuses stale binary
...
# K-067 — Playwright dev workflow reuses stale binary

## Context

Playwright dev workflow gap: reuseExistingServer config reuses stale :8080 binary instead of building fresh from source.
