---
id: K-015
title: Integration tests with real MQTT broker
...
# K-015 — Integration tests with real MQTT broker

## Context

Integration tests — end-to-end with real MQTT broker. Deferred until core features stabilize.
