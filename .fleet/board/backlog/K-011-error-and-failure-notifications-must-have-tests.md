...
title: Error and failure notifications must have tests
...
# K-011 — Error and failure notifications must have tests

## Context

Error and failure notifications. Must have tests. Notify user when a print job encounters an error or fails.
