...
title: reuseExistingServer hazard gate on CI
...
# K-046 — reuseExistingServer hazard gate on CI

## Context

reuseExistingServer hazard. Gate on !process.env.CI to prevent stale binary reuse in development.
