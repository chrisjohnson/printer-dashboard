...
title: Alt-port mode for Playwright
...
# K-048 — Alt-port mode for Playwright

## Context

Alt-port mode for Playwright. Env override for Listen, real alt-port in playwright.config.ts.
