---
id: K-008
title: Camera stream proxy must have tests
...
# K-008 — Camera stream proxy must have tests

## Context

Camera stream proxy for MJPEG/RTSP through the server. Must have tests. H2S piece is done (K-001); P1S proxy needs tests and possibly auth.
