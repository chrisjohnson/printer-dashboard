...
title: Docker Compose for multi-service deployment
...
# K-012 — Docker Compose for multi-service deployment

## Context

Docker Compose file for multi-service deployment. Should include the dashboard app, any needed dependencies.
