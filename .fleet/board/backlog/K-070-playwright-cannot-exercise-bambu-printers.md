...
title: Playwright cannot exercise Bambu printers
...
# K-070 — Playwright cannot exercise Bambu printers

## Context

Playwright suite cannot exercise Bambu printers. Fake test credentials fail against real api.bambulab.com. Needs mock Bambu cloud login endpoint.
